...
min (julianday ("DatumUmrti", 'start of day')- julianday("Datum_1", 'start of day')) OVER (PARTITION BY (julianday("DatumUmrti", 'start of day') - julianday('2020-01-01','start of day'))) AS MINDAYDIFF
